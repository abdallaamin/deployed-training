...
//         switch (endpoint) {
//             case "Admins":
//                 url = 'http://localhost:3900/api/users/addAdmins';
//                 loggerMail = 'superAdmin1@vodafone.com';
//                 break;
//             case "SPOCS":
//                 url = 'http://localhost:3900/api/users/addSPOCs';
//                 loggerMail = 'admin3@vodafone.com';
//                 break;
//             case "Managers":
//                 url = 'http://localhost:3900/api/users/addManagers';
//                 loggerMail = 'admin3@vodafone.com';
//                 break;
//             default:
...
export async function PostMultiAdmins(data) {
    try {
        // Replace 'YOUR_API_ENDPOINT' with the actual endpoint URL where you want to send the data.
        const response = await axios.post('http://localhost:3900/api/users/addAdmins', data, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'superAdmin1@vodafone.com',
            },
...
export async function PostMultiSPOCS(data) {
    try {
        // Replace 'YOUR_API_ENDPOINT' with the actual endpoint URL where you want to send the data.
        const response = await axios.post('http://localhost:3900/api/users/addSPOCs', data, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'admin3@vodafone.com',
            },
...
export async function PostMultiManagers(data) {
    try {
        // Replace 'YOUR_API_ENDPOINT' with the actual endpoint URL where you want to send the data.
        const response = await axios.post('http://localhost:3900/api/users/addManagers', data, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'admin3@vodafone.com',
            },
...
export async function DeleteSingleUser(userId) {
    try {
        ...
        const response = await axios.post('http://localhost:3900/api/users/deleteusers', requestBody , {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'superAdmin1@vodafone.com',
            },
...
export async function updateBulkUsers(usersId ,status) {
    try {
        ...
        const response = await axios.post('http://localhost:3900/api/users/updatestatus', requestBody, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'superAdmin1@vodafone.com',
            },
...
export async function AddNewSingleAdmin(adminName, adminEmail) {
    try {
        ...
        const response = await axios.post('http://localhost:3900/api/users/addAdmins', requestBody, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'superAdmin1@vodafone.com',
            },
...
export async function AddNewSingleSPOC(userName, userEmail) {
    try {
        ...
        const response = await axios.post('http://localhost:3900/api/users/addSPOCs', requestBody, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'admin3@vodafone.com',
            },
...
export async function AddNewSingleManager(userName, userEmail) {
    try {
        ...
        const response = await axios.post('http://localhost:3900/api/users/addManagers', requestBody, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'admin3@vodafone.com',
            },
...
export async function fetchUsersDataByRoleInDep(userRole) {
    try {
        ...
        const response = await axios.post('http://localhost:3900/api/users/?page=1&limit=14', requestBody, {
            headers: {
                'Content-Type': 'application/json',
                'loggerMail': 'admin3@vodafone.com',
            },
