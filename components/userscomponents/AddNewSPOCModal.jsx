...
import { AddNewSingleSPOC } from '../../lib/userrequestBE.js'
...
export default function AddNewUserModal() {
    ...
    const handleAddUser = async () => {
        try {
            ...
            const response = await AddNewSingleSPOC(userName, userEmail);
    ...
    return (
        <div >
            ...
            <Dialog open={open} onClose={handleClose} scroll='body' width='417px' height='294px'>
                <DialogTitle xs={{ color: 'red' }}>Add New SPOC</DialogTitle>
