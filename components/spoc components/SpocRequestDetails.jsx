...
import TrainingForm from '../TrainingComponents/trainingcontent/TrainingForm'
import IconButton from '@mui/joy/IconButton';
import CloseOutlinedIcon from '@mui/icons-material/CloseOutlined';
import Link from '@mui/material/Link';
import expand from '../../public/expand.png';

const SpocModalDetails = () => {
    ...
    return (
        <div>
            <Button component={Link} onClick={handleClickOpen('body')} color='transparnt' size="sm"
                variant="plain" sx={{ color: '#767474' }}>
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
                    <Image src={expand} alt='expand' width='15px' height='15px' style={{margin:'3px'}}/>
                View
...
export default SpocModalDetails
