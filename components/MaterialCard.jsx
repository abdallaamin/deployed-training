...
import AltUploadAdmins from './AltUpload'
import AltUploadManager from './AltUploadManagers'
...
export default function BasicCard({ buttontext }) {
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '13px' }}>
                <CardContent style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ position: 'absolute', right: '55px', paddingTop: '3px' }}>
                        {buttontext === "Admins" && <AltUploadAdmins />}
                        {buttontext === "SPOCS" && <AltUploadSPOCS  />}
                        {buttontext === "Managers" && <AltUploadManager />}
                    </div>
                </CardContent>
            </div>
        </Card>
